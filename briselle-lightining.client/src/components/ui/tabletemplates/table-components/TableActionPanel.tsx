...
import Action_Search from '../table-components/tableActions/Action_Search';
...
const TableActionPanel: React.FC<TableActionPanelProps> = ({
    ...
    const leftAlignedButtons: any[] = [];
    const rightAlignedButtons: any[] = [];
    ...
    //        leftAlignedButtons.push(button);
    //    } else {
    //        rightAlignedButtons.push(button);
    //    }
    //}
