...
import {
    ...
    isDobjRegistryInlineEditExcluded,
...
export default function TempList2() {
    ...
    const objectsInlineEditCandidateKeys = useMemo(
        () => Object.keys(fieldMappings).filter((k) => !isDobjRegistryInlineEditExcluded(k)),
        [fieldMappings],
    );
    ...
    return (
        <ConfigurableListTemplate
            ...
            inlineEditCandidateKeys={objectsInlineEditCandidateKeys}
        />
    );
}
