...
export const slashMenuSections = [
  {
    ...
    items: [
      ...
      { icon: '📄', name: 'Page', desc: 'Embed a sub-page', type: 'sub_page' },
      { icon: '☑', name: 'To-do List', desc: 'Track tasks with checkboxes', type: 'todo' },
      ...
      { icon: '▶', name: 'Toggle List', desc: 'Collapsible toggle block', type: 'toggle' },
      { icon: '❝', name: 'Quote', desc: 'Capture a quote', type: 'quote' },
      { icon: '—', name: 'Divider', desc: 'Horizontal divider line', type: 'divider' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '🎬', name: 'Video', desc: 'Embed a video', type: 'video' },
      { icon: '🎵', name: 'Audio', desc: 'Embed audio', type: 'audio' },
      { icon: '📎', name: 'File', desc: 'Upload or link a file', type: 'file' },
      { icon: '💻', name: 'Code', desc: 'Code block with syntax highlighting', type: 'code' },
      { icon: '🔗', name: 'Web Bookmark', desc: 'Save a link as visual bookmark', type: 'bookmark' },
    ],
  },
  {
    label: 'Advanced',
    items: [
      ...
      { icon: '📑', name: 'Table of Contents', desc: 'Auto-generated from headings', type: 'toc' },
      { icon: '🗂', name: 'Tabs', desc: 'Tabbed content block', type: 'tabs' },
      { icon: '∑', name: 'Equation', desc: 'LaTeX math equation', type: 'equation' },
      { icon: '▶𝗛₁', name: 'Toggle Heading 1', desc: 'Collapsible large heading', type: 'toggle_heading1' },
      { icon: '▶𝗛₂', name: 'Toggle Heading 2', desc: 'Collapsible medium heading', type: 'toggle_heading2' },
      { icon: '▶𝗛₃', name: 'Toggle Heading 3', desc: 'Collapsible small heading', type: 'toggle_heading3' },
    ],
  },
];
