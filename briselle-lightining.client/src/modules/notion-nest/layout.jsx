...
export const CoverImage = memo(function CoverImage() {
  ...
  return (
    <div className="page-cover">
      <img src={pageState.cover} alt="Cover" />
      <div className="page-cover-actions">
        <button className="page-cover-btn" onClick={() => { const u = prompt('Enter new cover image URL:'); if (u) updatePage({ cover: u }); }}>Change cover</button>
        <button className="page-cover-btn" onClick={() => updatePage({ cover: null })}>Remove</button>
      </div>
    </div>
  );
});
  ...
  return (
    <div className="page-header">
      ...
      <div className="page-header-actions">
        {!pageState.icon && (
          <button className="page-header-action-btn" onClick={handleIconClick}>🎨 Add icon</button>
        )}
        {!pageState.cover && (
          <button className="page-header-action-btn" onClick={() => {
            const u = prompt('Enter cover image URL:');
            if (u) updatePage({ cover: u });
          }}>🖼 Add cover</button>
        )}
        <button className="page-header-action-btn" onClick={() => {}}>💬 Add comment</button>
      </div>
